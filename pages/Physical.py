...
physical_datatable = pd.read_csv(DATA_PATH.joinpath("Physical-data.csv"))
            ...
            html.Div([
                html.Div([
                    html.Div([
                        html.Div([
                            html.Div([
                                html.H6(["Physical Resiliency Score"]),
                                html.P(["96.03 (-1.05)"])
                            ], className="pr-score"),

                            html.Div([
                                html.Div([
                                    html.H5(["Physical Resiliency Score"]),
                                    html.P(["(Live graph)"]),
                                ], className="pr-score"),
                                html.Div([
                    ...
                    html.Div([
                        html.Div([
                            dash_table.DataTable(id="pr-table",
                                                 ...
                                                 data=physical_datatable.to_dict('records'),
                                                 selected_columns=["1", "2"]),
